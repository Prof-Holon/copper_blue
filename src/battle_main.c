...
const u8 gTypeEffectiveness[330] =
{
    ...
    TYPE_PSYCHIC, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
    ...
    TYPE_GHOST, TYPE_FIGHTING, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_ROCK, TYPE_ELECTRIC, TYPE_MUL_NOT_EFFECTIVE,
